...
&nbsp;&nbsp;&nbsp;&nbsp;Locate the icon file called "application.icns" inside the Processing sketch data folder, and copy it to the clipboard.<br>
&nbsp;&nbsp;&nbsp;&nbsp;Delete the "source" folder inside the export folder, leaving only the application itself.<br>
&nbsp;&nbsp;&nbsp;&nbsp;Right click the application "Ceiling_Interface" and choose "Show package contents", to see the files behind.<br>
&nbsp;&nbsp;&nbsp;&nbsp;Go to "Contents->Resources" and paste the icon file. (choose replace when asked to replace or keep existing icon file)<br>
